...
// with the other mid-session diagnostics sinks (plugin manager, orchestrator,
// tool package); the -check-compaction preflight and every headless flow run
// with no sink installed and keep the stderr behavior.
